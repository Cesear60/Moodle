...
class __Mustache_0a874bb5e55b6482da149d7dcd37a123 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                    <div class="form-input">
';
        $buffer .= $indent . '                        <input type="password" name="password" id="password" size="15" value="" autocomplete="current-password">
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
